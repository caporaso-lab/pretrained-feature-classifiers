...
wget https://github.com/BenKaehler/readytowear/blob/master/data/gg_13_8/515f-806r/average.qza \
    -O "${weights_515_806}"
wget https://github.com/BenKaehler/readytowear/blob/master/data/gg_13_8/full_length/average.qza \
    -O "${weights}"
